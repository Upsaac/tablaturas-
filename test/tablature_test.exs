defmodule TablatureTest do
  ...
  test "Stairway to Heaven (multiple strings)" do
    # se modifico el texto ya que tenia caracteres raros, y daba problemas
    tab = """
          e|-------5-7-----7-|
          B|-----5-----5-----|
          G|---5---------5---|
   ...
   test "Stairway to Heaven (silences and divisions)" do
    tab = """
          ...
          E|-----------------|-----------------|-----------------|-----------------|
          """
    expected = "D7 G5 B5 e5 e7/D6 B5 G5 e7 e8/D5 B5 G5 e8 e2/D4 B3 G2 e2 e0/D3 B1 G2 B1 _ e0 B1 G2 B0/G0/A2 B1/G2/A0 B1/G2/A0 _ G2/A0 _ A8 A7"
    assert Tablature.parse(tab) == expected
  end
  ...
  expected = "D7 G5 B5 e5 e7/D6 B5 G5 e7 e8/D5 B5 G5 e8 e2/D4 B3 G2 e2 e0/D3 B1 G2 B1 _ e0 B1 G2 B0/G0/A2 B1/G2/A0 B1/G2/A0 _ G2/A0 _ A8 A7 A0 D7 G5 B5 e7/D6 B5 G5 e7 e8/D5 B5 G5 e8 e2/D4 B3 G2 e2 e0/D3 B1 G2 B1 _ e0 B1 G2 B0/G0/A2 B1/G2/A0 B1/G2/A0 _ _ _ A0 A2"
  assert Tablature.parse(tab) == expected
end
end
